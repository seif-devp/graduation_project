...
class AiMatchDialog extends StatelessWidget {
  final double score;
          ...
          child: Column(
            ...
            children: [
              ...
              if (matchedSkills.isNotEmpty) ...[
                ...
                SizedBox(height: 8.h),
                Wrap(spacing: 8.w, runSpacing: 8.h, children: matchedSkills.map((s) => _buildChip(s, Colors.green.shade50, Colors.green)).toList()),
                SizedBox(height: 15.h),
              ],
              ...
              if (missingSkills.isNotEmpty) ...[
                ...
                SizedBox(height: 8.h),
                Wrap(spacing: 8.w, runSpacing: 8.h, children: missingSkills.map((s) => _buildChip(s, Colors.red.shade50, Colors.red)).toList()),
              ],
            ],
          ),
        ),
  ...
  Widget _buildBulletPoint(String text) {
    return Padding(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(child: Text(text, style: TextStyle(color: Colors.grey.shade700, fontSize: 13.sp)))
      ])
    );
  }
  ...
  Widget _buildChip(String label, Color bgColor, Color textColor) {
    return Chip(
      label: Text(label, style: TextStyle(color: textColor, fontSize: 11.sp)), 
