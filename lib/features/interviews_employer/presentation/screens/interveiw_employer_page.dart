...
import 'package:graduation_project/features/interviews_employer/data/repo_employer_imp.dart';
import 'package:graduation_project/features/interviews_employer/presentation/cubit/interview_employer_cubit.dart';
import 'package:graduation_project/features/interviews_employer/presentation/cubit/interview_employer_state.dart';
import 'package:graduation_project/features/interviews_employer/widgets/card_interveiw.dart';
        ...
        body: SafeArea(
          child: BlocBuilder<InterviewCubitEmployer, InterviewStateEmployer>(
            builder: (context, state) {
              ...
              if (state is InterviewEnployerLoaded) {
                if (state.interviewsEmployer.isEmpty) {
                  return Padding(
                    padding:
